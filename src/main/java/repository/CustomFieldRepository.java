...
public class CustomFieldRepository {
    ...
    public void inserIntoTableComponents(OracleConnection connection,
                                         List<CustomField> fields) throws SQLException {
        String sql =
                """
        ...
        try(Connection conn = connection.getConnection()) {
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                new SyncInfoRepository().insertIntoTableSyncInfo(connection, "COMPONENTS");
                conn.commit();
